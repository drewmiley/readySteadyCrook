function draw(canvas, smallImageCanvas, largeImageCanvas, smallImage, largeImage,
    { size, ratio, rectRand, preview, persist, sampleOptions, bleedOptions, distortionOptions, colormergeOptions, concentrateOptions, setToWhiteColors }
) {
    ...
    const getFillRectIJ = getFillRect(ctx, largeCanvas, smallCanvas, ratio, rectRand, sampleOptions, bleedOptions, distortionOptions, colormergeModifiedOptions, concentrationValues, setToWhiteColors);
